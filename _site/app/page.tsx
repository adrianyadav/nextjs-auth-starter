      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
          <div className="text-center">
            {/* Main Heading */}
            <h1 className="text-6xl md:text-8xl font-black text-foreground mb-6 leading-tight animate-fade-in-up">
              Save Your
            ...
            {/* Subtitle */}
            <p className="text-xl md:text-3xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed font-light animate-fade-in-up-delayed">
              Organize your favorite outfits, discover new styles, and never forget what to wear again.
              <span className="block text-lg md:text-xl mt-2 text-muted-foreground/80">
                Your personal fashion archive, beautifully organized.
              </span>
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 animate-fade-in-up-delayed-2">
              {session ? (
                <>
            ...
            {/* Community Message */}
            <div className="flex items-center justify-center text-sm text-muted-foreground animate-fade-in-up-delayed-3">
